...
This folder defines all source code for the 'labevents' pipeline:
...
* Take a look at the sample under "sample_users_labevents.sql" to get familiar with the syntax.
