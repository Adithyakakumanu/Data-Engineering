...
This folder defines all source code for the 'drgcodes' pipeline:
...
* Take a look at the sample under "sample_users_drgcodes.sql" to get familiar with the syntax.
